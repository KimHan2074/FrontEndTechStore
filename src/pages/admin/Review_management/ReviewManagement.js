...
export default function ReviewManagement() {
  ...
  useEffect(() => {
    setLoading(true);
    fetch("https://backendtechstore1-production.up.railway.app/api/admin/reviews")
      .then((res) => res.json())
      .then((data) => {
  ...
  const handleDeleteReview = (id) => {
    ...
    fetch(`https://backendtechstore1-production.up.railway.app/api/admin/delete-reviews/${id}`, {
      method: "DELETE",
    })
      .then((res) => res.json())
      .then((data) => {
