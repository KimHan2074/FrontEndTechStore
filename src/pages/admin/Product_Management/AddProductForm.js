    ...
    const fetchData = async () => {
      try {
        const [categoryRes, promoRes] = await Promise.all([
          ...
          axios.get("https://backendtechstore1-production.up.railway.app/api/admin/promotion-types"),
        ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://backendtechstore1-production.up.railway.app/api/admin/create/products",
        dataToSend,
        {
          headers: {
