...
//           <button type="button" className="signin-social-button signin-apple-button" onClick={handleAppleSignIn}>
...
console.log(response.data);
      ...
      alert("Đăng nhập thất bại. Kiểm tra lại tên hoặc mật khẩu.");
    }
  };
    ...
    <div className="signin-container">
      <div className="signin-form-card">
        <div className="signin-tab-container">
          <Link
            to="/signin"
            className={`signin-tab ${location.pathname === "/signin" ? "signin-tab-active" : ""}`}
          >
            Sign In
          </Link>
          <Link
            to="/signup"
            className={`signin-tab ${location.pathname === "/signup" ? "signin-tab-active" : ""}`}
          >
            Sign Up
          </Link>
        </div>
        ...
        <form onSubmit={handleSubmit} className="signin-form-content">
          <div className="signin-form-group">
            <label htmlFor="name" className="signin-label">FullName</label>
            <input
              type="text"
              id="name"
              name="name"
