const PaymentConfirmation = ({
  ...
  orderItems = [
    ...
    },
    {
      ...
      description: "256GB, Natural, Black",
      quantity: 1,
      price: 49000,
    },
  ],
        ...
        <div className="card-content">
          ...
          <div className="price-summary">
            ...
            <div className="price-row">
              ...
              <span className="price-value">${shippingFee}</span>
            </div>
            <div className="price-row">
          ...
          <div className="email-notice">
            ...
            <div className="email-text">
              Order confirmation email will be sent to {customerInfo.email.split("@")[0]}***@gmail.com after you
              confirm.
            </div>
          </div>
