...
const UserProfile = () => {
  ...
  const fetchUserIdAndData = async () => {
    ...
    try {
      ...
      const userIdResponse = await axios.get("https://backendtechstore1-production.up.railway.app/api/user/getUserId", {
      ...
      const userResponse = await axios.get(`https://backendtechstore1-production.up.railway.app/api/user/${fetchedUserId}`, {
        headers: { Authorization: `Bearer ${token}` },
        withCredentials: true,
      });
  ...
  const handleProfileUpdate = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://backendtechstore1-production.up.railway.app/api/user/update-profile/${userId}`,
        {
  ...
  try {
    const response = await fetch(`https://backendtechstore1-production.up.railway.app/api/user/change-password/${userId}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const saveAvatarToDatabase = async (avatarUrl) => {
    ...
    try {
      await axios.put(
        `https://backendtechstore1-production.up.railway.app/api/user/update-avatar/${userId}`,
        { avatar: avatarUrl },
        {
