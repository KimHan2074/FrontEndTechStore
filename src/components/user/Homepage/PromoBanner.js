    ...
    const fetchData = async () => {
      try {
        const [productRes, promotedRes] = await Promise.all([
          axios.get("https://backendtechstore1-production.up.railway.app/api/user/product/index"),
          axios.get("https://backendtechstore1-production.up.railway.app/api/user/product/promoted"),
        ]);
